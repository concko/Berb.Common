...
namespace LeagueSharp.SDK
{
    ...
    public static partial class Damage
    {
        ...
        private static void CreatePassives()
        {
            ...
            AddPassiveAttack(
                string.Empty,
                (hero, @base) => hero.HasBuff("Muramana") && hero.ManaPercent >= 20 && @base is AIHeroClient,
                DamageType.Physical,
            ...
            AddPassiveAttack(
                string.Empty,
                (hero, @base) => hero.HasBuff("Mastery6261") && @base is AIHeroClient,
                DamageType.Magical,
                ...
                switch (name)
                {
                    case "Aatrox":
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.W),
                            true);
                        break;
                    case "Akali":
                        AddPassiveAttack(
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.Q, DamageStage.Detonation),
                            true);
                        break;
                    case "Alistar":
                        AddPassiveAttack(
                    ...
                    case "Ashe":
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.Q) * hero.GetCritMultiplier(true),
                            true,
                            true);
                        break;
                    case "Bard":
                    ...
                    case "Blitzcrank":
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.E),
                            true);
                        break;
                    case "Braum":
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) => 32 + (8 * ((AIHeroClient)@base.GetBuff("braummark").Caster).Level));
                        AddPassiveAttack(
                            "Braum",
                    ...
                    case "Draven":
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.Q),
                            true);
                        break;
                    case "Ekko":
                        AddPassiveAttack(
                    ...
                    case "Elise":
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.R, DamageStage.SecondForm),
                            true);
                        break;
                    case "Fiora":
                        AddPassiveAttack(
                    ...
                    case "Fizz":
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.W) * 0.5 / 3,
                            true);
                        AddPassiveAttack(
                            "Fizz",
                            (hero, @base) => hero.HasBuff("FizzSeastonePassive"),
                            DamageType.Magical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.W, DamageStage.Empowered),
                            true);
                        break;
                    case "Gangplank":
                        AddPassiveAttack(
                    ...
                    case "Illaoi":
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) =>
                            hero.LSGetSpellDamage(@base, SpellSlot.W)
                            + hero.LSGetSpellDamage(@base, SpellSlot.Q)
                    ...
                    case "Jayce":
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) =>
                            hero.LSGetSpellDamage(@base, SpellSlot.W, DamageStage.SecondForm)
                            * hero.GetCritMultiplier(true),
                            true,
                            true);
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.R),
                            true);
                        break;
                    case "Jhin":
                        AddPassiveAttack(
                    ...
                    case "Kalista":
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) =>
                            ((AIHeroClient)@base.GetBuff("kalistacoopstrikemarkbuff").Caster).LSGetSpellDamage(
                                @base,
                                SpellSlot.W),
                            true);
                        break;
                    ...
                    case "Kayle":
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) =>
                            hero.LSGetSpellDamage(@base, SpellSlot.E) * (hero.HasBuff("JudicatorRighteousFury") ? 2 : 1),
                            true);
                        break;
                    case "Kennen":
                        AddPassiveAttack(
                    ...
                    case "KogMaw":
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) =>
                            hero.LSGetSpellDamage(@base, SpellSlot.W) * (@base is Obj_AI_Minion ? 1 : 0.55),
                            true);
                        break;
                    case "Leona":
                        AddPassiveAttack(
                            ...
                            (hero, @base) =>
                                {
                                    var lvl = ((AIHeroClient)@base.GetBuff("leonasunlight").Caster).Level - 1;
                                    if ((lvl / 2) % 1 > 0)
                                    {
                                        lvl -= 1;
                                    }
                    ...
                    case "Malphite":
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.W) * hero.GetCritMultiplier(true),
                            true);
                        break;
                    case "MasterYi":
                        AddPassiveAttack(
                    ...
                    case "Mordekaiser":
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) =>
                            hero.LSGetSpellDamage(@base, SpellSlot.Q) * (hero.HasBuff("mordekaisermaceofspades2") ? 2 : 1),
                            true);
                        break;
                    case "Nami":
                        AddPassiveAttack(
                            ...
                            (hero, @base) =>
                                {
                                    var caster = (AIHeroClient)hero.GetBuff("NamiE").Caster;
                                    return
                    ...
                    case "Nasus":
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) =>
                            hero.LSGetSpellDamage(@base, SpellSlot.Q) * hero.GetCritMultiplier(true)
                    ...
                    case "Nautilus":
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.W) / (@base is AIHeroClient ? 1 : 2),
                            true);
                        break;
                    case "Nidalee":
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) =>
                            hero.LSGetSpellDamage(@base, SpellSlot.Q, DamageStage.SecondForm)
                    ...
                    case "Renekton":
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) =>
                            (hero.LSGetSpellDamage(@base, SpellSlot.W) * (hero.Mana >= 50 ? 1.5 : 1))
                            * hero.GetCritMultiplier(true),
                            true,
                            true);
                        break;
                    case "Rengar":
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.Q, DamageStage.Empowered),
                            true);
                        break;
                    case "Riven":
                        AddPassiveAttack(
                    ...
                    case "Shen":
                        AddPassiveAttack(
                            ...
                            (hero, @base) =>
                                {
                                    var dmg = hero.LSGetSpellDamage(@base, SpellSlot.Q);
                                    if (@base is AIHeroClient && @base.HasBuff("ShenQSlow"))
                                    {
                                        dmg += hero.LSGetSpellDamage(@base, SpellSlot.Q, DamageStage.Empowered);
                                    }
                                    return dmg;
                                },
                            true);
                    ...
                    case "Shyvana":
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.W) * 0.25,
                            true);
                        AddPassiveAttack(
                            "Shyvana",
                            (hero, @base) => @base.HasBuff("ShyvanaFireballMissile"),
                            DamageType.Magical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.E, DamageStage.Detonation),
                            true);
                        break;
                    case "Sion":
                        AddPassiveAttack(
                    ...
                    case "Sona":
                        ...
                        AddPassiveAttack(
                            ...
                            (hero, @base) =>
                                {
                                    var caster = (AIHeroClient)hero.GetBuff("SonaQProcAttacker").Caster;
                                    return
                    ...
                    case "Talon":
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) =>
                            @base is AIHeroClient
                            ? hero.LSGetSpellDamage(@base, SpellSlot.Q, DamageStage.Empowered)
                            : hero.LSGetSpellDamage(@base, SpellSlot.Q),
                            true);
                        break;
                    case "Taric":
                    ...
                    case "Teemo":
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) =>
                            hero.LSGetSpellDamage(@base, SpellSlot.E)
                            + (hero.LSGetSpellDamage(@base, SpellSlot.E, DamageStage.DamagePerSecond)
                               / (@base is AIHeroClient ? 1 : 4)),
                            true);
                        break;
                    case "Thresh":
                        AddPassiveAttack(
                            ...
                            (hero, @base) =>
                                {
                                    ...
                                    var dmg = hero.LSGetSpellDamage(@base, SpellSlot.E, DamageStage.Empowered);
                    ...
                    case "Tristana":
                        AddPassiveAttack(
                            ...
                            (hero, @base) =>
                            hero.LSGetSpellDamage(@base, SpellSlot.E)
                            + (hero.LSGetSpellDamage(@base, SpellSlot.E, DamageStage.Buff) / 3 * 4),
                            true);
                        break;
                    case "Trundle":
                        AddPassiveAttack(
                    ...
                    case "TwistedFate":
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Magical,
                            (hero, @base) => hero.LSGetSpellDamage(@base, SpellSlot.W, DamageStage.Detonation),
                            true,
                            true);
                        AddPassiveAttack(
                            "TwistedFate",
                    ...
                    case "Udyr":
                        ...
                        AddPassiveAttack(
                            ...
                            DamageType.Physical,
                            (hero, @base) =>
                            hero.LSGetSpellDamage(@base, SpellSlot.Q, DamageStage.DamagePerSecond)
                            / (@base is AIHeroClient ? 1 : 2),
                            true);
                        break;
                    case "Varus":
        ...
        private struct PassiveDamage
        {
            ...
            public Func<AIHeroClient, Obj_AI_Base, bool> Condition { get; set; }

            public DamageType DamageType { get; set; }

            public Func<AIHeroClient, Obj_AI_Base, double> Func { get; set; }
